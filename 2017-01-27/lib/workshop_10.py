...
def ggpl_house_builder():
	...
	return (w_08.ggpl_house_builder(externalWallsLinesPath,internalWallsLinesPath,windowsLinesPath,internalDoorsLinesPath,externalDoorsLinesPath)(XWindow,YWindow,occurencesWindow)(XDoor,YDoor,occurencesDoor))
